                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 36px; height: 36px; background: var(--color-surface); border: 1px solid var(--color-border);">
                                            <i class="fa-solid fa-building small" style="color: var(--color-primary);"></i>
                                        </div>
                                        <span class="fw-bold" style="color: var(--color-text-main);">{{ $v->name }}</span>
                                    </div>
                                </td>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-outline-action btn-sm" style="padding: 6px 16px; font-size: 0.85rem;" data-bs-toggle="modal" data-bs-target="#editVendor{{ $v->id ?? 0 }}">
                                        Review
                                    </button>
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="4" class="text-center py-5" style="color: var(--color-text-muted);">
                                    <i class="fa-solid fa-building-circle-xmark display-5 mb-3" style="color: var(--color-primary); opacity: 0.5;"></i>
