                        ...
                        @forelse($vendors ?? [] as $v)
                            <tr>
                                ...
                                <td class="text-center">
                                    <button class="btn btn-sm btn-light text-secondary fw-semibold border"
                                        data-bs-toggle="modal" data-bs-target="#vendorModal{{ $v->id }}">
                ...
                <div class="modal-content" style="border-radius: 15px;">
                    ...
                    <form action="/vendors/{{ $v->id }}/update-status" method="POST">
                        ...
                        <div class="modal-footer border-0 p-4">
                            ...
                            <button type="submit" class="btn text-white" style="background-color: #fe81d4;">Perbarui
                                Status</button>
                        </div>
                    </form>
                </div>
