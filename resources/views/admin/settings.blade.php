...
<div class="container-fluid p-0">
    ...
    <div class="mb-4">
        ...
        <p class="mb-0 fw-medium" style="color: var(--color-text-muted);">Perbarui tingkat keamanan akun dan atur opsi pemberitahuan sistem</p>
    </div>
    ...
    <ul class="settings-tab-container nav flex-nowrap overflow-x-auto pb-2 mb-4" id="settingsTab" role="tablist" 
        ...
        <li class="nav-item" role="presentation">
            <button class="settings-tab-link active py-3 px-4" id="security-tab" data-bs-toggle="tab" data-bs-target="#security-pane" type="button" role="tab" aria-selected="true" style="font-weight: 700; transition: all 0.3s ease;">
        ...
        <li class="nav-item" role="presentation">
            <button class="settings-tab-link py-3 px-4" id="notification-tab" data-bs-toggle="tab" data-bs-target="#notification-pane" type="button" role="tab" aria-selected="false" style="font-weight: 700; transition: all 0.3s ease;">
    ...
    <div class="tab-content" id="settingsTabContent">
        ...
        <div class="tab-pane fade show active" id="security-pane" role="tabpanel" aria-labelledby="security-tab">
            <div class="card card-custom border-0 shadow-sm" style="background: var(--color-white); border-radius: var(--radius-card, 16px);">
                <div class="card-body p-4">
                    <h6 class="fw-bold mb-3" style="color: var(--color-text-main);"><i class="fa-solid fa-lock me-2 text-warning"></i>Ubah Password Administrator</h6>
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" name="current_password" class="form-control auth-input" placeholder="Masukkan password lama" required>
                        </div>
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                <label class="form-label small fw-bold text-muted">Password Baru</label>
                                <input type="password" name="new_password" class="form-control auth-input" placeholder="Minimal 8 karakter" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label small fw-bold text-muted">Konfirmasi Password Baru</label>
                                <input type="password" name="new_password_confirmation" class="form-control auth-input" placeholder="Ketik ulang password baru" required>
                            </div>
                        </div>
                        <button type="submit" class="btn btn-primary-action px-4 py-2 fw-bold shadow-sm" style="background-color: var(--color-primary); color: var(--color-white); border-radius: 8px;">
        ...
        <div class="tab-pane fade" id="notification-pane" role="tabpanel" aria-labelledby="notification-tab">
            ...
            <div class="card card-custom border-0 shadow-sm mb-3" style="background: var(--color-white); border-radius: var(--radius-card, 16px);">
                <div class="card-body p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        <h6 class="fw-bold mb-1" style="color: var(--color-text-main);">Popup Interaction Toast Alert</h6>
                        <p class="small mb-0" style="color: var(--color-text-muted);">Aktifkan untuk memunculkan pesan popup di kanan atas saat berinteraksi.</p>
                    </div>
                    <div class="form-check form-switch fs-4 mb-0">
                        <input class="form-check-input shadow-none cursor-pointer" type="checkbox" id="toggleToast" checked style="border-color: var(--color-border);">
                    </div>
                </div>
            </div>
            ...
            <div class="card card-custom border-0 shadow-sm mb-4" style="background: var(--color-white); border-radius: var(--radius-card, 16px);">
                <div class="card-body p-4 d-flex justify-content-between align-items-center flex-wrap gap-3">
                    <div>
                        <h6 class="fw-bold mb-1" style="color: var(--color-text-main);">Pemberitahuan Sistem (Tender & Vendor)</h6>
                        <p class="small mb-0" style="color: var(--color-text-muted);">Matikan sakelar ini untuk menghentikan pengiriman pesan notifikasi otomatis ke dalam sistem log user.</p>
                    </div>
                    <div class="form-check form-switch fs-4 mb-0">
                        <input class="form-check-input shadow-none cursor-pointer" type="checkbox" id="toggleSystemNotif" checked style="border-color: var(--color-border);">
                    </div>
                </div>
            </div>
