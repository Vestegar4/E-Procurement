...
<div class="container-fluid p-0">
    ...
    <div class="row g-4 mb-5">
        {{-- Card 1: Total Vendor --}}
        <div class="col-md-4">
            <div class="card card-custom p-4 border-0 position-relative overflow-hidden" style="background: var(--color-white);">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-uppercase fw-bold small tracking-wider mb-2" style="color: var(--color-text-muted); letter-spacing: 0.05em; font-size: 0.85rem;">Total Vendor Rekanan</p>
                        <h2 class="m-0" style="color: var(--color-text-main); font-weight: 800; font-size: 2.5rem; letter-spacing: -0.02em;">{{ $vendorCount ?? 0 }}</h2>
                    </div>
                    <div class="rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="background-color: var(--color-primary); width: 56px; height: 56px;">
                        <i class="fa-solid fa-users fa-lg" style="color: var(--color-accent);"></i>
                    </div>
                </div>
                {{-- Border aksen bawah tipis untuk indikator visual --}}
                <div class="position-absolute bottom-0 start-0 w-100" style="height: 4px; background: var(--color-accent);"></div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card card-custom p-4 border-0 position-relative overflow-hidden" style="background: var(--color-white);">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-uppercase fw-bold small tracking-wider mb-2" style="color: var(--color-text-muted); letter-spacing: 0.05em; font-size: 0.85rem;">Total Tender Aktif</p>
                        <h2 class="m-0" style="color: var(--color-text-main); font-weight: 800; font-size: 2.5rem; letter-spacing: -0.02em;">{{ $tenderCount ?? 0 }}</h2>
                    </div>
                    <div class="rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="background-color: var(--color-primary); width: 56px; height: 56px;">
                        <i class="fa-solid fa-gavel fa-lg" style="color: var(--color-accent);"></i>
                    </div>
                </div>
                <div class="position-absolute bottom-0 start-0 w-100" style="height: 4px; background: var(--color-primary);"></div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card card-custom p-4 border-0 position-relative overflow-hidden" style="background: var(--color-white);">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <p class="text-uppercase fw-bold small tracking-wider mb-2" style="color: var(--color-text-muted); letter-spacing: 0.05em; font-size: 0.85rem;">Purchase Orders (PO)</p>
                        <h2 class="m-0" style="color: var(--color-text-main); font-weight: 800; font-size: 2.5rem; letter-spacing: -0.02em;">{{ $resultCount ?? 0 }}</h2>
                    </div>
                    <div class="rounded-circle d-flex align-items-center justify-content-center shadow-sm" style="background-color: var(--color-primary); width: 56px; height: 56px;">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="rounded-circle d-flex align-items-center justify-content-center" style="width: 36px; height: 36px; background: var(--color-surface);">
