            ...
            <div class="top-navbar">
                ...
                <div class="top-right d-flex align-items-center gap-3">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow border-0 p-2 mt-2" aria-labelledby="profileDropdown" style="border-radius: 12px; min-width: 220px;">
                            <li class="px-3 py-2">
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        window.triggerSystemEvent = function(title, message, iconType) {
            ...
            if (isSystemNotifEnabled === true) {
                const badge = document.getElementById('notification-badge-count') || document.querySelector('#notifDropdown .badge');
                if (badge) {
